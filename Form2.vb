...
Public Class NewCustomer
    ...
    Private Sub NewCustomer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'SalesDataSet.Customer' table. You can move, or remove it, as needed.
        Me.CustomerTableAdapter.Fill(Me.SalesDataSet.Customer)

    End Sub

    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        If ComboBox1.SelectedItem Is "Light LED" Then
            '' Light LED", "Cable", "Fuse", "TV", "Remote
            numOrderAmount.Value = 200
        ElseIf ComboBox1.SelectedItem Is "Cable" Then
            numOrderAmount.Value = 1000
        ElseIf ComboBox1.SelectedItem Is "Fuse" Then
            numOrderAmount.Value = 500
        ElseIf ComboBox1.SelectedItem Is "TV" Then
            numOrderAmount.Value = 4000
        Else
            numOrderAmount.Value = 300
        End If
    End Sub
